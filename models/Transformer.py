...
class Config(object):
    ...
    def __init__(self, embedding):
        ...
        self.require_improvement = 2000                                 # If there has been no improvement after 1000
        self.num_classes = len(self.class_list)                         # batches, end the training early.
        self.n_vocab = 0                                                # number of maximum vocabulary
        self.num_epochs = 20                                            # epoch number
...
class Scaled_Dot_Product_Attention(nn.Module):
    ...
    def forward(self, Q, K, V, scale=None):
        ...
        Args:
            ...
            scale: \sqrt{dim_K}
        Return:
            tenser after self-attention，tenser of attention
        '''
